...
public class GetBank {
    ...
    private final static int[] bankBin = {
            621446, 621098, 622150, 622151, 622181, 622188, 955100, 621095, 620062, 621285, 621798, 621799,
            ...
            622536, 622538, 622539, 622983, 998800, 623052};
    // "发卡行.卡种名称",
    private static final String[] bankName = {
            "长沙银行", "邮储银行·绿卡通", "邮储银行·绿卡银联标准卡", "邮储银行·绿卡银联标准卡", "邮储银行·绿卡专用卡", "邮储银行·绿卡银联标准卡",
